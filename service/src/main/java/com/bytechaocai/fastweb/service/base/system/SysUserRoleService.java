...
import com.bytechaocai.fastweb.data.dao.system.SysUserRoleRepository;
...
* @author bytechaocai
*/
public interface SysUserRoleService extends BaseService<SysUserRoleEntity, String, SysUserRoleDAO, SysUserRoleRepository> {
}
